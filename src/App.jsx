...
import Profile from './features/anime/screens/profile.jsx';
...
import MangaProfile from './features/manga/screens/profile.jsx';
...
const App = () => {
  return (
    <Routes>
      ...
      <Route path="/manga/profile" element={<MangaProfile />} />
